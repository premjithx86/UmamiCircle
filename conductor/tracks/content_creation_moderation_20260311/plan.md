...
- [x] Task: Implement Image Moderation Pipeline (3215241)
...
- [x] Task: Implement Text Moderation (3215241)
...
- [x] Task: Implement Create Post Endpoint (1086338)
    - [x] Create `src/routes/postRoutes.js`.
    - [x] Implement `POST /api/posts` with full moderation pipeline.
- [x] Task: Implement Create Recipe Endpoint (1086338)
